...
Within the OHDSI sphere it is customary that a study has a accompanying shiny app, to visualize the data. `OhdsiShinyModules` was developed to standardize shiny apps for commonly ran analyses, mainly from the `HADES` suite.

`OhdsiShinyModules` seems to be air tight in the way it functions, without much room for flexibility. It has to, to maintain the level of standardization it provides. It offers the most extreme opposite of what developing a fully customized shiny app would be.
...
```
![](./img/1-iris.png){#id .class width=100%}
![](./img/1-mtcars.png){#id .class width=100%}
...
```
![](./img/1-tab-plot-3.png){#id .class width=100%}
![](./img/1-tab-plot-2.png){#id .class width=100%}
![](./img/1-tab-plot-1.png){#id .class width=100%}
